...
- **실행**: `C:\Users\monG\AppData\Local\Programs\Python\Python313\python.exe run_hylabel.py`
...
```
HyLabel/
├── run_hylabel.py          # 진입점 (labeler.main.main 호출)
...
| 최근 경로 기억 | `QSettings("HyLabel","HyLabel")` key=`lastDir` |
